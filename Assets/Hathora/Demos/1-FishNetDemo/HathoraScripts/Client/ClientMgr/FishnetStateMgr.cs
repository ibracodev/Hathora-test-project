...
namespace Hathora.Demos._1_FishNetDemo.HathoraScripts.Client.ClientMgr
{
    ...
    public class FishnetStateMgr : NetworkMgrStateTracker
    {
        ...
        private bool validateIsReadyToConnect()
        {
            ...
            // Validate transport
            Tugboat tugboatTransport = transport as Tugboat; 
...
#else
            Assert.IsNull(tugboatTransport, "!Expected NetworkManager to use " +
                $"{nameof(tugboatTransport)} for !WebGL build - Set NetworkManager "+
